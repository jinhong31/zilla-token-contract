...
interface IZillaToken {
  function balanceOf(address _user) external view returns(uint256);
  function transfer(address _user, uint256 amount) external ;  
}
contract ZillaFarm is Ownable {
  IZillaNFT public zillaNft;
  IZillaToken public zillaToken;
  ...
  constructor (
    ...
    zillaNft = IZillaNFT(nftAddr);
    zillaToken = IZillaToken(ftAddr);
  }
